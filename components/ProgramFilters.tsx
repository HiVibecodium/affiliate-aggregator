  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6 sticky top-4">
      ...
      <div className="space-y-4">
        ...
        {/* Country filter - Hidden until we have more data */}
        {/* Currently only 2 countries (US, GB) - not useful enough to show */}
        {/* Will re-enable when we add more international affiliate networks */}
        {filters && filters.countries && filters.countries.length > 3 && (
          <div>
